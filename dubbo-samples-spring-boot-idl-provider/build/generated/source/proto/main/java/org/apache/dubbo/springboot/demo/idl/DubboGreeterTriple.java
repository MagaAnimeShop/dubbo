...
public final class DubboGreeterTriple {
    ...
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.springboot.demo.idl.GreeterRequest::parseFrom,
    org.apache.dubbo.springboot.demo.idl.GreeterReply::parseFrom);
    private static final StubMethodDescriptor getCategoryMethod = new StubMethodDescriptor("getCategory",
    org.apache.dubbo.springboot.demo.idl.CategoryRequest.class, org.apache.dubbo.springboot.demo.idl.CategoryResponse.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.springboot.demo.idl.CategoryRequest::parseFrom,
    org.apache.dubbo.springboot.demo.idl.CategoryResponse::parseFrom);

    private static final StubMethodDescriptor getCategoryAsyncMethod = new StubMethodDescriptor("getCategory",
    org.apache.dubbo.springboot.demo.idl.CategoryRequest.class, java.util.concurrent.CompletableFuture.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.springboot.demo.idl.CategoryRequest::parseFrom,
    org.apache.dubbo.springboot.demo.idl.CategoryResponse::parseFrom);

    private static final StubMethodDescriptor getCategoryProxyAsyncMethod = new StubMethodDescriptor("getCategoryAsync",
    org.apache.dubbo.springboot.demo.idl.CategoryRequest.class, org.apache.dubbo.springboot.demo.idl.CategoryResponse.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), org.apache.dubbo.springboot.demo.idl.CategoryRequest::parseFrom,
    org.apache.dubbo.springboot.demo.idl.CategoryResponse::parseFrom);
    ...
    static{
        ...
        serviceDescriptor.addMethod(getCategoryMethod);
        serviceDescriptor.addMethod(getCategoryProxyAsyncMethod);
    }
    ...
    public static class GreeterStub implements Greeter{
        ...
        @Override
        public org.apache.dubbo.springboot.demo.idl.CategoryResponse getCategory(org.apache.dubbo.springboot.demo.idl.CategoryRequest request){
            return StubInvocationUtil.unaryCall(invoker, getCategoryMethod, request);
        }

        public CompletableFuture<org.apache.dubbo.springboot.demo.idl.CategoryResponse> getCategoryAsync(org.apache.dubbo.springboot.demo.idl.CategoryRequest request){
            return StubInvocationUtil.unaryCall(invoker, getCategoryAsyncMethod, request);
        }

        public void getCategory(org.apache.dubbo.springboot.demo.idl.CategoryRequest request, StreamObserver<org.apache.dubbo.springboot.demo.idl.CategoryResponse> responseObserver){
            StubInvocationUtil.unaryCall(invoker, getCategoryMethod , request, responseObserver);
        }
    ...
    public static abstract class GreeterImplBase implements Greeter, ServerService<Greeter> {
        ...
        @Override
        public CompletableFuture<org.apache.dubbo.springboot.demo.idl.CategoryResponse> getCategoryAsync(org.apache.dubbo.springboot.demo.idl.CategoryRequest request){
                return CompletableFuture.completedFuture(getCategory(request));
        }
        ...
        */
        ...
        public void getCategory(org.apache.dubbo.springboot.demo.idl.CategoryRequest request, StreamObserver<org.apache.dubbo.springboot.demo.idl.CategoryResponse> responseObserver){
            getCategoryAsync(request).whenComplete((r, t) -> {
                if (t != null) {
                    responseObserver.onError(t);
                } else {
                    responseObserver.onNext(r);
        ...
        public final Invoker<Greeter> getInvoker(URL url) {
            ...
            pathResolver.addNativeStub( "/" + SERVICE_NAME + "/getCategory");
            pathResolver.addNativeStub( "/" + SERVICE_NAME + "/getCategoryAsync");
            // for compatibility
            pathResolver.addNativeStub( "/" + JAVA_SERVICE_NAME + "/getCategory");
            pathResolver.addNativeStub( "/" + JAVA_SERVICE_NAME + "/getCategoryAsync");
            ...
            BiConsumer<org.apache.dubbo.springboot.demo.idl.CategoryRequest, StreamObserver<org.apache.dubbo.springboot.demo.idl.CategoryResponse>> getCategoryFunc = this::getCategory;
            handlers.put(getCategoryMethod.getMethodName(), new UnaryStubMethodHandler<>(getCategoryFunc));
            BiConsumer<org.apache.dubbo.springboot.demo.idl.CategoryRequest, StreamObserver<org.apache.dubbo.springboot.demo.idl.CategoryResponse>> getCategoryAsyncFunc = syncToAsync(this::getCategory);
            handlers.put(getCategoryProxyAsyncMethod.getMethodName(), new UnaryStubMethodHandler<>(getCategoryAsyncFunc));
        ...
        @Override
        public org.apache.dubbo.springboot.demo.idl.CategoryResponse getCategory(org.apache.dubbo.springboot.demo.idl.CategoryRequest request){
            throw unimplementedMethodException(getCategoryMethod);
        }
